...
import type { TemporaryCategories } from '@/lib/types';
import { doc, setDoc } from 'firebase/firestore';
import { db } from '@/lib/firebase';

interface TemporaryBudgetsCategoriesModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function TemporaryBudgetsCategoriesModal({ isOpen, onClose, categories, appId }: TemporaryBudgetsCategoriesModalProps) {
  ...
  const saveCategories = async (updatedCategories: TemporaryCategories) => {
    try {
      const categoriesRef = doc(db, "artifacts", appId, "public", "data", "temp_categories", "temp_categories");
    ...
    <>
      <Dialog open={isOpen} onOpenChange={handleDialogClose}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-center">Gestión de Categorías Temporales</DialogTitle>
          </DialogHeader>
