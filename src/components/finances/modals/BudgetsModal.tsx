      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-3xl">
          <DialogHeader className="flex-row items-center justify-between">
            <DialogTitle className="text-2xl font-bold text-center flex-grow">Gestión de Presupuestos</DialogTitle>
            {isPastMonth && (
               <Button
                  variant="ghost"
                  size="icon"
                ...
                >
                  ...
                  <span className="sr-only">{pastDateLock ? 'Desbloquear Edición' : 'Bloquear Edición'}</span>
                </Button>
            )}
          </DialogHeader>
